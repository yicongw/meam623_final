...
oracles~\cite{deits2023neuralcbf}, which is the route VPP-TC follows.
...
(RDF)~\cite{liu2024rdf}; precomputed Bernstein polynomial SDFs
...
\bibitem{zhang2025vpptc} J.~Zhang, F.~Khadivar, and N.~Figueroa,
``Viability-preserving passive torque control for safe physical
human-robot interaction,'' \textit{IEEE T-RO}, 2025.
\bibitem{kronander2016passive} K.~Kronander and A.~Billard,
``Passive interaction control with dynamical systems,''
\textit{IEEE RAL}, vol.~1, no.~1, pp.~106--113, 2016.
\bibitem{zhang2024cpic} J.~Zhang and N.~Figueroa,
``CPIC: A constrained passive interactive controller for safe
human-robot interaction,'' \textit{IROS}, 2024.
\bibitem{figueroa2018lpvds} N.~Figueroa and A.~Billard,
``A physically-consistent Bayesian non-parametric mixture model
for dynamical system learning,'' \textit{CoRL}, 2018.
\bibitem{ames2019cbf} A.~D. Ames, S.~Coogan, M.~Egerstedt et al.,
``Control barrier functions: Theory and applications,''
\textit{ECC}, 2019.
\bibitem{aubin1991viability} J.-P.\ Aubin,
\textit{Viability Theory}, Birkh\"auser, 1991.
\bibitem{deits2023neuralcbf} R.~Deits, A.~Bajcsy, and C.~Sloth,
``Learning safe control with neural CBFs,''
\textit{ICRA workshop}, 2023.
\bibitem{khansari2014hopf} M.~Khansari-Zadeh and A.~Billard,
``Learning control Lyapunov function to ensure stability of
dynamical system-based robot reaching motions,''
\textit{Robotics Auton.\ Syst.}, vol.~62, no.~6, pp.~752--765, 2014.
\bibitem{khalil2002nonlinear} H.~K. Khalil,
\textit{Nonlinear Systems}, 3rd ed., Prentice Hall, 2002.
\bibitem{cvxpy} S.~Diamond and S.~Boyd,
``CVXPY: A python-embedded modeling language for convex
optimization,'' \textit{JMLR}, 17(83):1--5, 2016.
\bibitem{osqp} B.~Stellato, G.~Banjac, P.~Goulart et al.,
``OSQP: An operator splitting solver for quadratic programs,''
\textit{Math.\ Prog.\ Comp.}, 12:637--672, 2020.
\bibitem{enactic2024openarm} Enactic Inc.,
``OpenArm: An open-source bimanual humanoid platform,''
\url{https://github.com/enactic/openarm_description}, 2024.
\bibitem{liu2024rdf} Y.~Liu et al.,
``Robot distance fields for whole-body collision avoidance,''
\textit{ICRA}, 2024.
\end{thebibliography}
